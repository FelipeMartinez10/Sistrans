...
public class Carga_maritima {
	...
	public Carga_maritima(@JsonProperty(value="ID_OPERACION")int iD_OPERACION,@JsonProperty(value="ID_CARGA_MARITIMA") int iD_CARGA_MARITIMA,@JsonProperty(value="ID_MUELLE") int iD_MUELLE,@JsonProperty(value="ID_CARGA") int iD_CARGA, @JsonProperty(value="ID_BUQUE")int iD_BUQUE,
			@JsonProperty(value="ID_EQUIPO_APOYO")int iD_EQUIPO_APOYO) {
		super();
