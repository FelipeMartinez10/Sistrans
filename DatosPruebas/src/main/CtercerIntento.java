...
public class CtercerIntento 
{
	...
	public boolean satisfaceSat(int[] pBalanza)
	{
		...
		/*if(valorPasado == 0 )
		{
			if(balanza[posCambio] == 1)
			{
				pesoCalculado += pBalanza[posCambio]*pesos[posCambio];
			}
			else if(balanza[posCambio] == -1)
			{
				pesoCalculado -= pBalanza[posCambio]*pesos[posCambio];
			}
		}
		else if(valorPasado == 1)
		{
			if( balanza[posCambio] == 0)
			{
				pesoCalculado -= pBalanza[posCambio]*pesos[posCambio];
			}	
		}
	...
	public static void main(String[] args) {
		...
		CtercerIntento nuevo = new CtercerIntento();
